...
import { categories, brands, tierColorClass, type Product } from '@/data/products'
...
function CategoryPills({
  ...
  active: string
  onChange: (c: typeof categories[number] | 'Все') => void
      ...
      {allPills.map((pill, i) => {
        ...
        return (
          <motion.button
            ...
            onClick={() => onChange(pill as typeof categories[number] | 'Все')}
            className={cn(
...
function BrandFilter({
  ...
  selected: string[]
  toggle: (b: typeof brands[number]) => void
}) {
        ...
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col lg:flex-row items-stretch lg:items-center gap-3">
            ...
            <div className="flex items-center gap-2 shrink-0">
              <BrandFilter selected={selectedBrands} toggle={toggleBrand} />
