          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                <a href={phoneHref(settings.phone)} className="text-guard-green font-medium">
                  {settings.phone}
                </a>
              </div>
              <div className="flex items-center gap-2">
                <Mail size={16} className="text-text-muted" />
                <a href={`mailto:${settings.email}`} className="text-sm text-text-muted hover:text-guard-green transition-colors">
                  {settings.email}
                </a>
              </div>
              <p className="text-sm text-text-muted">{settings.working_hours}</p>
            </div>
            <div className="flex items-center gap-4 mt-4">
              <a href={settings.telegram} target="_blank" rel="noopener noreferrer" className="text-text-muted hover:text-guard-green transition-colors" aria-label="Telegram">
              ...
              <a href={settings.whatsapp} target="_blank" rel="noopener noreferrer" className="text-text-muted hover:text-guard-green transition-colors" aria-label="WhatsApp">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href={settings.vk} target="_blank" rel="noopener noreferrer" className="text-text-muted hover:text-guard-green transition-colors" aria-label="VK">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
